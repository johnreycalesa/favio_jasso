      ...
      <form
        ...
        <div class="flex flex-col gap-3">
          ...
          <input
            ...
            v-model="name" type="text" placeholder="Enter your Name" required />
        </div>
        <div class="flex flex-col gap-3">
          ...
          <input
            ...
            v-model="email" type="email" placeholder="Enter your email address" required />
        </div>
        <div class="flex flex-col gap-3">
          <span class="uppercase md:capitalize text-sm md:text-2xl text-white md:text-primary font-bold">
            Message
          ...
          <textarea
            ...
            v-model="message" placeholder="Enter your Message" required></textarea>
        </div>
        <div class="flex flex-col gap-3">
          <button
