...
<template>
  <div class="wrapper pt-2 md:pt-10">
    <div class="px-5 flex flex-row justify-around py-5 sm:py-10 lg:py-24 bg-tertiary-light text-white xl:rounded-t-lg">
      <form
        ...
        <div class="flex flex-col gap-3">
          <span class="text-sm md:text-2xl text-white sm:text-primary font-bold uppercase md:capitalize">
            Full Name
          </span>
          <input
        ...
        <div class="flex flex-col gap-3">
          <span class="uppercase md:capitalize text-sm md:text-2xl text-white sm:text-primary font-bold">
            Email
          </span>
          <input
      ...
      <div class="hidden md:flex flex-col justify-center md:w-1/2 md:pl-14 pr-5 py-5 gap-8">
        <div class="flex justify-end gap-3">
          ...
          <!-- email icon -->
          <a href="mailto:fjporras04@gmail.com">
