    ...
    <div
      ...
      <form
        ...
        <div class="flex flex-col gap-3">
          <span class="text-sm md:text-2xl text-white md:text-primary font-bold uppercase md:capitalize">
            Full Name
          </span>
          <input
            ...
            v-model="name" type="text" placeholder="Enter your Name" id="name" required />
        </div>
        <div class="flex flex-col gap-3">
          <span class="uppercase md:capitalize text-sm md:text-2xl text-white md:text-primary font-bold">
            Email
          </span>
          <input
            ...
            v-model="email" type="email" placeholder="Enter your email address" id="email" required />
        </div>
        <div class="flex flex-col gap-3">
          <span class="uppercase md:capitalize text-sm md:text-2xl text-white md:text-primary font-bold">
            Message
          ...
          <textarea
            ...
            v-model="message" placeholder="Enter your Message" id="message" required></textarea>
        </div>
        <div class="flex flex-col gap-3">
          <button
...
function sendEmail() {
  ...
  axios.post('http://localhost/ci3/send', ).then((response) => {
