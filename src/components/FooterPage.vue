    ...
    >
      ...
      >
        ...
        <div class="flex flex-col gap-3">
          ...
          <input
            class="w-full bg-white sm:bg-gray-200 text-gray-900 p-3 rounded-lg focus:outline-none focus:shadow-outline focus:ring-2 focus:ring-orange-400"
            type="text"
        ...
        <div class="flex flex-col gap-3">
          ...
          <textarea
            class="w-full h-32 bg-white sm:bg-gray-200 text-gray-900 p-3 rounded-lg focus:outline-none focus:shadow-outline focus:ring-2 focus:ring-orange-400"
